...
public class pruebaUnitaria02 {
    ...
    public static void main(String[] args) {
        ...
        test.AprobarCotizacion();
        test.rechazarCotizacion();
    }
    ...
    public void AprobarCotizacion() {
        ...
        try {
            ...
            WebElement aprobarCotizacion = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/html/body/div[2]/div/div[6]/button[1]")));
            aprobarCotizacion.click();
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            driver.quit();
    ...
    public void rechazarCotizacion() {
        ...
        try {
            ...
            // Esperar hasta que el botón de confirmación de SweetAlert sea visible y clicable
            WebElement sweetAlertCancelBtn = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button.swal2-cancel.swal2-styled")));
            sweetAlertCancelBtn.click();
